...
## this assumes that all block are equal and there is no variation
## if block two has a higher soil quality, it will inflate the variation in the model
## if we ignore variation in the model, we underestimate unertainity. 
...
### we are throwing away information in the varaition by assmuming the fertilizer treatments control the yield independently, while ignoring the soil quality in the fields. It will underestimate our standard error. It will make it more difficult to understand our variation in the blocks. 
```
